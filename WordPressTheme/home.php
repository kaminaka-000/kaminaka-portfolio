      ...
      <section class="sub-mv">
        <div class="sub-mv__inner">
          ...
          <div class="sub-mv__img">
            <picture>
              <source media="(min-width: 768px)" srcset="<?php echo esc_url(get_theme_file_uri('/assets/images/common/abstract4.jpeg')); ?>"/>
              <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/common/abstract44.jpeg')); ?>" alt="<?php echo esc_attr('写真:青と茶色のぼかしがかった色調で描かれた抽象画。'); ?>" />
            </picture>
          </div>
        </div>
      </section>
